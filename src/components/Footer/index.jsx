        ...
        <div className="row gx-5 pt-3 mx-0">
          <div className="col-lg-4 col-md-12 footer__first-col">
            ...
            <div className="footer__first-col__text d-flex justify-content-center text-white mt-4">
              Emma là nơi mọi người mặc trang phục có thể cảm thấy sự thoải mái
              nhất
            </div>
          ...
          <div className="col-lg-1 col-md-4 text-white text-center">
            <div className="footer__title mt-5 pb-3">Emma Store</div>
            <a href="">
              <div className="footer__item">Tại sao là Emma</div>
            </a>
            <a href="">
          ...
          <div className="col-lg-4 col-md-12 d-flex justify-content-center footer__first-col fifth_col text-white">
            <div>
              ...
              >
                ...
                <div className="footer__location">support@Emmafashion.com</div>
              </div>
            </div>
          </div>
          <hr style={{ border: "2px solid #3D3F4E", marginTop: "150px" }} />
          <div className="text-white text-center pb-4 pt-4 h6">
            Trang webste thương hiệu thời trang emma - © 2024
          </div>
        </div>
      </div>
    </footer>
