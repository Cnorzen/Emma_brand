...
const SuccessStory = () => {
  const data = {
    title:
      "Chung tay hỗ trợ quyên góp quần áo vải vóc: Ánh Sáng ấm áp cho trẻ em đặc biệt khó khăn tại Vùng núi sâu xa",
    description:
      'Trong vùng núi sâu, Emma hợp tác nhóm "Chung Tay Hỗ Trợ" cùng nhau tài trợ quyên góp quần áo đã mang lại sự ánh sáng ấm áp cho trẻ em bằng những món quà nhỏ và tình yêu thương. Hành động này không chỉ là sự quyên góp vật chất, mà còn là biểu tượng của lòng nhân ái và hy vọng. Cùng nhau, chúng ta đã tạo ra những khoảnh khắc ý nghĩa và ấm áp, gửi đi thông điệp rằng không ai phải đối mặt với cuộc sống một mình.',
    totalFounded: "326",
    author: {
      name: "Nguyễn Kim Dét ",
